...
class GFBluePayData{
    ...
    public static function update_table(){
        global $wpdb;
        $table_name = self::get_blue_pay_table_name();
    ...
    public static function get_blue_pay_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_blue_pay";
    }

    public static function get_transaction_table_name(){
        global $wpdb;
        return $wpdb->prefix . "rg_blue_pay_transaction";
    }
    ...
    public static function drop_tables(){
        global $wpdb;
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_blue_pay_table_name());
    }
